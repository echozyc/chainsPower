  ...
  <div class="otc-wrap">
    <div class="otc-top">
      ...
      <div class="otc-top-img wow fadeInLeft">
        <img src="../../../assets/img/bibijiaoyi_pic.png" alt="">
      </div>
      <div class="otc-top-text wow fadeInLeft">
          <span>
                专业的数字资产场外交易系统，支持国内、海外搭建。安全稳定、专业可靠，支持数字资产的管理、交易、风险控制等一系列的生态流程。<br><br>

                系统采用金融系统主流的java语言开发，稳定高效的系统架构，多重加密方式，匠心打造服务一体化的场外交易平台系统。<br><br>

                主要是针对虚拟货币和虚拟货币之间的交易，以其中一种币作为计价单位去购买其他币种。币币交易规则同样是按照价格优先时间先顺序完成撮合交易。
          </span>
      </div>

    </div>

    <div class="banner-wrap wow zoomIn">

      <div class="swiper-container" style="width: 100%;height:100%">
        <div class="swiper-wrapper">
          <div class="swiper-slide list">
            <div class="banner-list">
              <p class="banner-title">币币交易平台的由来</p>
              <span class="banner-text">数字资产基于区块链技术和平台，也是区块链最典型的应用。以比特币为例，其平台仅提供各用户间转账的功能，
                缺乏交易和支付功能造成比特币无法真正流通，也就不能成为真正的货币。因此，数字资产交易平台孕育而生。截止到目前，
                交易平台也是区块链行业的标杆应用场景。</span>
              <img src="../../../assets/img/bibi_pic_1.png" alt="">
            </div>
          </div>
          <div class="swiper-slide list">
            <div class="banner-list">
              <p class="banner-title">交易平台的功能</p>
              <span class="banner-text">用户之间的币币交易、支付、充值、提现、资产管理、撮合交易、资产清算、期货、理财。由此可见，
                数字货币交易平台完全可以成为一个超级金融中心。</span>
              <img src="../../../assets/img/bibi_pic_2.png" alt="">
            </div>
          </div>
          <div class="swiper-slide list">
            <div class="banner-list">
              <p class="banner-title">交易平台的盈利模式</p>
              <span class="banner-text">所有数字货币交易、兑换、上线交易平台的佣金、提现手续费、用户保证金利息；平台沉淀资金复利投资，
                上线自己发行的数字资产等，成为一个中心化、无监管的赚钱利器。</span>
              <img src="../../../assets/img/bibi_pic_3.png" alt="">
            </div>
          </div>
        </div>
    ...
    <div class="otc-system">
      ...
      <div class="otc-system-lists">
        ...
        <div class="otc-system-list wow fadeInUp">
          <img src="../../../assets/img/bibi_ico_3.png" alt="">
          <p>多种交易<br>
            模式</p>
        </div>
        <div class="otc-system-list wow fadeInUp">
    ...
    .otc-system
      ...
      .otc-system-lists
        ...
        .otc-system-list
          width 5.18rem
          height 6.69rem
          border 0.5px solid rgba(123,120,187,0.6);
    ...
    .otc-produce
      ...
      .otc-produce-lists
        ...
        .otc-produce-list
          ...
          width 4.98rem
          height 8.13rem
          border 1px solid rgba(123,120,187,0.6);
          border-radius 0.3rem;
          text-align center
          margin-right 0.3rem
          &:last-child
